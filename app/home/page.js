  ...
  return (
    <main className='w-full bg-[#F6F7F8] pb-14'>
      ...
      <div className='w-full max-sm:px-4 px-[8.5rem] '>
        <div className='bg-white w-full h-16 mt-14 shadow-ring rounded-lg'>
          <div className='flex'>
            <div className="grid grid-cols-12 w-4/5">
              <input type="text" placeholder='Pencarian' onChange={ (e) => handleSearch(e.target.value) } className='col-span-11 ms-6 border-0 h-16 focus:outline-none'/>
            ...
            <div className='relative w-1/4'>
              ...
              { toggleSort && 
                <div className='w-full absolute z-40 top-20 drop-shadow-md bg-white'>
                  <ul>
        ...
        <div className={`relative z-0 bg-white w-full mt-16 shadow-ring rounded-lg ${toggleSort && 'mt-44'}`}>
          {
